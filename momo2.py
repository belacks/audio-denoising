...
#        super().__init__()
#        assert in_size==1
#        self.downs = DownBlocks(in_size, hidden_sizes, output_size,
#                 kernel_sizes, 
#                 strides,
#                 paddings,
#                 num_gaussians=num_gaussians)
#        self.ups = UpBlocks(in_size, hidden_sizes, output_size,
#                 kernel_sizes, 
#                 strides,
#                 paddings,
#                 num_gaussians=num_gaussians)
#    def forward(self, x):
#        return self.ups(self.downs(x))
